    ...
    <div>
      <div id="Home" className="flex gap-14 flex-col justify-center items-center h-[500px]">
        ...
        <div className="flex items-center gap-4 mx-auto md:gap-5 ">
          <a href="#About" className="px-3 py-1 rounded-2xl bg-[#FFBD5B] font-semibold flex items-center gap-2">
            <p>Next</p>{" "}
            <span>
          ...
          <div className="flex items-center gap-2">
            <a href="https://www.instagram.com/secondary.sgd/" target="_blank" className="p-2 bg-[#FFBD5B] rounded-full">
            ...
            <a href="https://www.instagram.com/secondary.sgd/" target="_blank" className="text-white">
              Instagram
            </a>
          </div>
        </div>
